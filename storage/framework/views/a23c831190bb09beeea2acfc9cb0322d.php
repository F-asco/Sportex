    ...
    <div class="card shadow-sm border-0 p-4 w-100" style="max-width: 400px;">
        ...
        <form action="/login" method="POST">
            ...
            <div class="text-center">
                ...
                <a href="/register" class="small text-decoration-none">Zarejestruj się</a>
            </div>
        </form>
    </div>
...
</html><?php /**PATH P:\Xampp\htdocs\sklep\resources\views/auth/login.blade.php ENDPATH**/ ?>