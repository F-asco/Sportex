            ...
            <form action="/admin/users" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="role" class="form-select">
                        <option value="client" <?php echo e(old('role') == 'client' ? 'selected' : ''); ?>>Klient</option>
                        <option value="employee" <?php echo e(old('role') == 'employee' ? 'selected' : ''); ?>>Pracownik / Moderator</option>
...
</html><?php /**PATH P:\Xampp\htdocs\sklep\resources\views/admin/create.blade.php ENDPATH**/ ?>