                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex gap-2 justify-content-center">
                                        <a href="/admin/users/{{ $user->id }}/edit" class="btn btn-sm btn-outline-primary">Edytuj</a>
                                        
                                        @if(auth()->id() !== $user->id)
                                            <form action="/admin/users/{{ $user->id }}" method="POST" class="m-0" onsubmit="return confirm('Czy na pewno chcesz usunąć tego użytkownika?');">
                                                @csrf
                                                @method('DELETE')
