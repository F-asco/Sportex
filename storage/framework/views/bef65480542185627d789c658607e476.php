...
<body class="bg-light">
    ...
    <div class="container" style="max-width: 800px;">
        <div class="card shadow-sm border-0 p-4 mb-4 text-center bg-white">
            ...
            <p class="text-muted">Witaj, <strong><?php echo e(auth()->user()->name); ?></strong>. Posiadasz uprawnienia do edycji, dodawania oraz usuwania towarów z asortymentu sklepu.</p>
        </div>
...
</html><?php /**PATH P:\Xampp\htdocs\sklep\resources\views/employee/dashboard.blade.php ENDPATH**/ ?>