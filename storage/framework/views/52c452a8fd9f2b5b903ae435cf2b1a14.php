            ...
            <div class="col-md-4">
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body text-center py-4">
                        ...
                        <h5 class="card-title fw-bold"><?php echo e(auth()->user()->name); ?></h5>
                        <p class="card-text text-muted small"><?php echo e(auth()->user()->email); ?></p>
                        <hr>
...
</html><?php /**PATH P:\Xampp\htdocs\sklep\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>