        ...
        <div class="card shadow-sm border-0 p-4 bg-white">
            ...
            <form action="/products" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="np. Piłka meczowa">
                </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-6">
                        ...
                        <input type="number" name="stock" value="{{ old('stock') }}" class="form-control" placeholder="0">
                    </div>
                </div>
